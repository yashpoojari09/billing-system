...
router.get("/:tenantId/invoices", auth_1.authenticateJWT, (0, rbac_1.authorizeRoles)([client_1.Role.ADMIN, client_1.Role.SUPERADMIN, client_1.Role.MANAGER]), auth_2.validateTenant, tenantController_1.listInvoices);
...
router.get('/:tenantId/settings', auth_1.authenticateJWT, (0, rbac_1.authorizeRoles)([client_1.Role.ADMIN, client_1.Role.SUPERADMIN, client_1.Role.MANAGER]), auth_2.validateTenant, tenantController_1.getTenantSettings);
router.put('/:tenantId/settings', auth_1.authenticateJWT, (0, rbac_1.authorizeRoles)([client_1.Role.ADMIN, client_1.Role.SUPERADMIN, client_1.Role.MANAGER]), auth_2.validateTenant, tenantController_1.updateTenantSettings);
