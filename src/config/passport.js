...
passport_1.default.use(new JwtStrategy(options, function (jwt_payload, done) { return __awaiter(void 0, void 0, void 0, function () {
    var user, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.user.findUnique({ where: { id: jwt_payload.id } })];
            case 1:
                user = _a.sent();
                if (user)
